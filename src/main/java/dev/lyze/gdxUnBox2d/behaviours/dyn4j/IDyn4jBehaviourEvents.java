...
public interface IDyn4jBehaviourEvents {
     ...
     */
    boolean onCollisionPreSolve(Behaviour other, ContactCollisionData<PhysicsBody> collision, org.dyn4j.dynamics.contact.Contact contact);
     ...
     * @param contact   the contact
     */
    boolean onCollisionPostSolve(Behaviour other, ContactCollisionData<PhysicsBody> collision, org.dyn4j.dynamics.contact.Contact contact);
     ...
     * contact constraint, use the {@link #onCollision(Behaviour, ContactCollisionData)}
     * method.
     *
     * @param other     The other object this object collides with.
     * @param collision the collision data
     * @param contact   the contact
     */
    void onCollisionEnter(Behaviour other, ContactCollisionData<PhysicsBody> collision, org.dyn4j.dynamics.contact.Contact contact);
     ...
     */
    void onCollisionStay(Behaviour other, ContactCollisionData<PhysicsBody> collision, org.dyn4j.dynamics.contact.Contact oldContact, org.dyn4j.dynamics.contact.Contact newContact);
     ...
     * @param contact   the contact
     */
    void onCollisionExit(Behaviour other, ContactCollisionData<PhysicsBody> collision, org.dyn4j.dynamics.contact.Contact contact);
